...
<h3>Goal:</h3> Build an end-to-end pipeline that predicts SKU-level demand by integrating "Hyper-local" signals (Weather + Holidays) to optimize inventory reorder points.<br>
